...
public class RegistroUsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        User newUser = new User(username, email, password, phoneNumber, "active", 1); // Por defecto, todos los nuevos usuarios serán activos y tendrán el rol de usuario normal (1)
        ...
        if (registroExitoso) {
            ...
            response.sendRedirect("Login.jsp"); // Página de inicio de sesión
        } else {
