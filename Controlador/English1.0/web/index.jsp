...
<html lang="es">
    ...
    <body>
        <div id="header">
            <p class ="TituloHeader">COLD ENGLISH</p> <p class ="TextoHeader">Proyecto Final - Pagina de Aprendimiento de Ingles - Programacion Web & Base de Datos II</p> <a href="Login.jsp" class="BotonHeader">Iniciar sesion</a>
        </div>
