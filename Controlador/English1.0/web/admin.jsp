<%-- 
    Document   : admin
    Created on : 30 abr 2024, 15:07:07
    Author     : MIGUEL
--%>
...
<html lang="en">
    ...
    <div class="page-header">
        <nav>
            <div class="logo">COLD ENGLISH</div> <!-- Agregar el texto aquí -->
            <!-- Otros elementos de navegación si los hay -->
        </nav>
    </div>
